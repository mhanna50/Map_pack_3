...
from backend.app.models.enums import ContentItemStatus, PostType, enum_values
...
class ContentItem(Base, UUIDPrimaryKeyMixin, TimestampMixin):
    ...
    content_type: Mapped[PostType] = mapped_column(
        Enum(PostType, name="post_type", values_callable=enum_values), nullable=False, default=PostType.UPDATE
    )
