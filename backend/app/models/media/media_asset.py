...
from backend.app.models.enums import MediaStatus, MediaType, enum_values
...
class MediaAsset(Base, UUIDPrimaryKeyMixin, TimestampMixin):
    ...
    media_type: Mapped[MediaType] = mapped_column(
        Enum(MediaType, name="media_type", values_callable=enum_values), nullable=False, default=MediaType.IMAGE
    )
    ...
    status: Mapped[MediaStatus] = mapped_column(
        Enum(MediaStatus, name="media_status", values_callable=enum_values),
