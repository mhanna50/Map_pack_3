...
from backend.app.models.enums import AutomationActionType, AutomationCondition, AutomationTriggerType, enum_values
...
class AutomationRule(Base, UUIDPrimaryKeyMixin, TimestampMixin):
    ...
    trigger_type: Mapped[AutomationTriggerType] = mapped_column(
        Enum(AutomationTriggerType, name="automation_trigger_type", values_callable=enum_values), nullable=False
    )
    condition: Mapped[AutomationCondition] = mapped_column(
        Enum(AutomationCondition, name="automation_condition", values_callable=enum_values), nullable=False
    )
    action_type: Mapped[AutomationActionType] = mapped_column(
        Enum(AutomationActionType, name="automation_action_type", values_callable=enum_values), nullable=False
    )
