...
from backend.app.models.enums import QnaStatus, enum_values
...
class QnaEntry(Base, UUIDPrimaryKeyMixin, TimestampMixin):
    ...
    status: Mapped[QnaStatus] = mapped_column(
        Enum(QnaStatus, name="qna_status", values_callable=enum_values), default=QnaStatus.DRAFT, nullable=False
    )
